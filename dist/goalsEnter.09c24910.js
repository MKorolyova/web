let goals;
//read doc
fetch("http://localhost:3000/goals").then((response)=>{
...
function loadPersonalGoals(classes) {
    let classesMarkup = ``;
    for(let i = 0; i < classes.length; i++)classesMarkup += `<div class="personal_goal stroke_green ${classes[i].background} ">
...
//# sourceMappingURL=goalsEnter.09c24910.js.map
